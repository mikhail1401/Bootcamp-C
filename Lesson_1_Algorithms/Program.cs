/*
1. Константные (Constant): Algorithms that take the same amount of time regardless of the size of the input. In Big O notation, these are denoted as O(1).
...
3. Линейные (Linear): Algorithms where the time taken increases linearly with the size of the input. Denoted as O(n).
